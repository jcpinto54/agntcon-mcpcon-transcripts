...
- **[`talks/`](talks/)** — one Markdown transcript per session, named by slug.
  Each carries the talk title, the speaker with background on who they are, and
  the raw transcript.
...
**No summaries.** These are raw transcripts. What the speaker said, not someone
