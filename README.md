...
### Thursday 17 September  (11/52 transcribed, 11 summarised, 29 with materials)
...
|   | 10:50 | Auditorium | [An Orchestra of Agents: What I Learned Running a Multi-Agent System for 5,000+ Developers](talks/orchestra-agents-i-learned-running-multi-agent-system/materials.md) | Muhammad Ahsan Ayaz |   | [x](talks/orchestra-agents-i-learned-running-multi-agent-system/materials.md) |
...
|   | 12:00 | Auditorium | [Delegated Authorization for AI Agents: How to Build an Agent with Fine-Grained Permissions](talks/delegated-authorization-ai-agents-build-agent-fine-grained/materials.md) | Sohan Maheshwar |   | [x](talks/delegated-authorization-ai-agents-build-agent-fine-grained/materials.md) |
...
|   | 12:35 | Auditorium | [We Built AI Agents To Fix Security Findings in Production — Here's What Developers Actually Merged](talks/we-built-ai-agents-fix-security-findings-production/materials.md) | Amine Boudraa, Ruchita Kshirsagar, Nihit Gupta, Gianfranco Romani |   | [x](talks/we-built-ai-agents-fix-security-findings-production/materials.md) |
...
|   | 15:45 | Auditorium | [Six Months of Proof: Independently-Verifiable Records for Agent Actions Under the EU AI Act](talks/six-months-proof-independently-verifiable-records-agent-actions/materials.md) | Steven Mih |   | [x](talks/six-months-proof-independently-verifiable-records-agent-actions/materials.md) |
...
|   | 16:20 | Auditorium | [90 Days To Agentic Engineering](talks/90-days-agentic-engineering/materials.md) | Thomas Schöne |   | [x](talks/90-days-agentic-engineering/materials.md) |
...
### Friday 18 September  (8/41 transcribed, 8 summarised, 22 with materials)
...
|   | 11:30 | Auditorium | [Governance You Can Run: Checkable Properties for Production Agents](talks/governance-can-run-checkable-properties-production-agents/materials.md) | Seshu Tolety |   | [x](talks/governance-can-run-checkable-properties-production-agents/materials.md) |
...
|   | 13:15 | Auditorium | [When Agents Run Healthcare: Building Reliable Agentic Systems in Highly Regulated Environments](talks/when-agents-run-healthcare-building-reliable-agentic-systems/materials.md) | Janosch Woschitz |   | [x](talks/when-agents-run-healthcare-building-reliable-agentic-systems/materials.md) |
...
|   | 14:25 | Auditorium | [Agent-Smith: Never Send a Human To Do a Machine’s Job](talks/agent-smith-never-send-human-do-machine-s/materials.md) | Glenn ten Cate, Jorge Carvalho |   | [x](talks/agent-smith-never-send-human-do-machine-s/materials.md) |
